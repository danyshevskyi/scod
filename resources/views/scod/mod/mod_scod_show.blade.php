<div class="modal fade" tabindex="-1" id="mod_scod_show">
...
<div class="modal-header 1bb sticky-top" style="background-color: white;">
    <h5 class="modal-title">   
        <a href="333"
           target="_blank"
           class="text-decoration-none 1text-primary 1fst-italic text-black text-end"
           id="href">
                SCOD 23
        </a>
    </h5>
...
<div class="text-center fst-italic mt-2 px-3 text-secondary">

<center>
<img src="resources/views/scod/img/stacker3.jpg" width="330px" class="text-center">
</center>
